...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if( $viewData['user']->hasPermission('permissions_view') ): ?>
          <li class="<?php echo ($viewData['menuActive']=='permissions')?'active':''; ?>">
            <a href="<?php echo BASE_URL; ?>permissions"><i class="fa fa-link"></i> <span>Permissões</span></a>
          </li>
        <?php endif; ?>
        
        <?php if( $viewData['user']->hasPermission('categories_view') ): ?>
          <li class="<?php echo ($viewData['menuActive']=='categories')?'active':''; ?>">
            <a href="<?php echo BASE_URL; ?>categories"><i class="fa fa-link"></i> <span>Categorias</span></a>
          </li>
        <?php endif; ?>

        <?php if( $viewData['user']->hasPermission('brands_view') ): ?>
          <li class="<?php echo ($viewData['menuActive']=='brands')?'active':''; ?>">
            <a href="<?php echo BASE_URL; ?>brands"><i class="fa fa-link"></i> <span>Marcas</span></a>
          </li>
        <?php endif; ?>

        <?php if( $viewData['user']->hasPermission('pages_view') ): ?>
          <li class="<?php echo ($viewData['menuActive']=='pages')?'active':''; ?>">
            <a href="<?php echo BASE_URL; ?>pages"><i class="fa fa-link"></i> <span>Páginas</span></a>
          </li>
        <?php endif; ?>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong class="obs">Copyright &copy; <?php echo date('Y'); ?> <a href="#">Loja Virtual 2.0</a></strong> Todos os direitos reservados.
  </footer>
