<!-- Content Header (Page header) -->
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group <?php echo (in_array('title', $errorItems))?'has-error':''; ?>">
                        ...
                        <input type="text" class="form-control" id="page_title" name="title" value="<?php echo utf8_encode($info['title']); ?>" />
                    </div>
    ...
    <!-- /.content -->
<script src="https://cdn.tiny.cloud/1/b8gw40se0avjxpl01h65q1uiivhhk4kwkblmowmkfymls3pa/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script>tinymce.init({
    selector:'#page_body',
    height:500,
    menubar:false,
